...
You can use [Cyberduck](http://cyberduck.ch/) or [CloudBerry](http://www.cloudberrylab.com/) and other known class libraries (S3.php, Boto) to connect with GRIDBLAZE API or you can find more details on [GRIDBLAZE API Document](http://developer.gridblaze.com/api_documentation.php).
